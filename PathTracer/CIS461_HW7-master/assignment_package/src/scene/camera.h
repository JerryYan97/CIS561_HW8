...
public:
    ...
    virtual Ray Raycast(const Point2f &pt);         //Creates a ray in 3D space given a 2D point on the screen, in screen coordinates.
    virtual Ray Raycast(float x, float y);            //Same as above, but takes two floats rather than a vec2.
